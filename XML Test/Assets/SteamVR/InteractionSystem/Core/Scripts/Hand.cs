...
namespace Valve.VR.InteractionSystem
{
    ...
    public class Hand : MonoBehaviour
    {
        ...
        public void AttachObject(GameObject objectToAttach, GrabTypes grabbedWithType, AttachmentFlags flags = defaultAttachmentFlags, Transform attachmentOffset = null)
        {
            ...
            {
                if (objectToAttach.CompareTag("cue"))
                {
                    gameObject.SendMessageUpwards("TwoHandGrabStart", SendMessageOptions.DontRequireReceiver);
                }
            ...
            if (attachedObject.HasAttachFlag(AttachmentFlags.ParentToHand) && attachedObject.attachedObject.gameObject != null)
            {
